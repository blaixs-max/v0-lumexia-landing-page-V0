...
export function DashboardHero() {
  ...
  return (
    <section className="relative min-h-[420px] md:h-[380px] rounded-2xl neon-border-box group flex-shrink-0 overflow-hidden mt-14 md:mt-0">
      ...
      {/* Hero Content */}
      <div className="relative z-10 flex flex-col justify-center h-full px-4 md:px-12 max-w-2xl pt-12 md:pt-0 pb-24 md:pb-0">
        <h1 className="font-serif font-bold text-2xl md:text-5xl leading-tight mb-2 tracking-wide uppercase text-white drop-shadow-lg">
          PLAY RACING GAME
          <br />
