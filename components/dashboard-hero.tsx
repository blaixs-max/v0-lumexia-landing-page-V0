  ...
  return (
    <section className="relative h-[380px] rounded-2xl neon-border-box group flex-shrink-0 overflow-hidden">
      ...
      <button
        ...
        className="absolute top-6 right-6 z-20 glass-panel px-4 py-2 rounded-full flex items-center gap-2 border border-[#00f0ff]/30 shadow-neon-cyan hover:bg-[#00f0ff]/10 transition-colors cursor-pointer"
      >
        ...
        <span className="text-sm font-medium text-[#a19bb8]">
          C.A: <span className="text-white font-mono text-xs">{CONTRACT_ADDRESS.slice(0, 6)}...{CONTRACT_ADDRESS.slice(-4)}</span>
        </span>
        {copied ? (
